  ...
  module Taggable
    ...
    def taggable_on(preserve_tag_order, *tag_types)
      ...
      if taggable?
        ...
        class_eval do
          has_many :taggings, as: :taggable, dependent: :destroy, class_name: ActsAsTaggableOn.tagging_class
          has_many :base_tags, through: :taggings, source: :tag, class_name: ActsAsTaggableOn.tag_class
